...
from api.bulletin_reviews_management import router as bulletin_reviews_router
from api.bulletin_export_logs_management import router as bulletin_export_logs_router
...
app.include_router(bulletin_reviews_router)
app.include_router(bulletin_export_logs_router)
